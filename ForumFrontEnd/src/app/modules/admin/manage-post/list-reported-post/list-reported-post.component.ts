...
@Component({
  selector: 'admin-list-reported-post',
  templateUrl: './list-reported-post.component.html',
  styleUrls: ['../../../../app.component.scss','./list-reported-post.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ListReportedPostComponent implements OnInit {
  ...
  getListPost(){
    ...
    this.articleService.getReportedListArticle(this.pagingRequest).subscribe(
      data => {
